...
const DataForm = ({dataForm, bankDetails, setData, formTitle}) => {
    ...
    return (
        <div className='dataForm'>
            ...
            {
                editFormStatus
                    ? <DataFormEdit state={state} bankDetails={bankDetails} setData={setData} setEditFormStatus={setEditFormStatus} dispatch={dispatch}/>
